...
import json
import urllib.parse
from duplicateLexemes import filterNonDuplicateLexeme
...
request_url = base_url + "/words?keyword=a&range=%5B1%2C%206%5D&examples=true"
    ...
    for item in ApiResponse:
        if 'PV' in item['wordClass']:
            ...
            if response2.status_code == 200:
                ...
                filterNonDuplicateLexeme(item['word'], usageExampleIgbo, item['definitions'][0], parseWord)
